        ...
        <div className="section-container">
            ...
            <div className="section-container-items slick-initialized slick-slider">
                <div className="section-container-item slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" >
                    ...
                    <div className="large-4 medium-4 small-12"><img className="section-img" src="./static/img/pilares/infraestructura/infraestructura-02.jpg" /></div>
                ...
                <div className="section-container-item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" role="option" aria-describedby="slick-slide20">
                    ...
                    <div className="large-4 medium-4 small-12"><img className="section-img" src="./static/img/pilares/infraestructura-slide-02.jpg" /><img className="section-img" src="./static/img/pilares/infraestructura-slide-03.jpg" /></div>
                ...
                <div className="section-container-item slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" >
                            ...
                            <div className="large-4 medium-5 small-12">
                                <h4 className="section-subtitle-minor is-previous">Ya estamos trabajando para que nuestro fútbol
    tengan una infraestructura de primer nivel.</h4><img className="section-img" src="./static/img/pilares/infraestructura-slide-01.jpg" /></div>
                            <div className="large-4 medium-4 small-12"><img className="section-img" src="./static/img/pilares/infraestructura-slide-02.jpg" /><img className="section-img" src="./static/img/pilares/infraestructura-slide-03.jpg" /></div>
                            <div className="large-4 medium-1 small-12">
                                <p>&nbsp;</p>
                            </div>
